...
- 계획(MVP): 각 카테고리 상위 30개 → 총 120개 제품
- **실제 적재 (2026-08-25): 362건** — skincare 122 · cleansing 118 · suncare 96 · mask_pack 26
  (수집은 소분류 단위로 이뤄져 카테고리별 수량이 균등하지 않다)
...
- 계획: 총 21,805개 성분 (KCIA 전체 규모)
- **실제 적재 (2026-08-25): 162종** — 전체의 부분집합
