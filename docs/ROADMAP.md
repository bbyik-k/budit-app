...
- **제품 검색 및 선택**: pg_trgm 기반 한글 부분 문자열 검색으로 올리브영 상위 362건 제품 탐색
...
- **Task 009: CSV 시드 데이터 준비** ✅ - 완료
  ...
  - ✅ 성분 마스터: 현재 162종 적재 (KCIA 전체 규모 약 21,805개 중 부분집합)
  ...
  - ✅ 제품 마스터: 올리브영 상위 362건 적재 (당초 계획 120건)
...
- **Task 025: Vercel 배포 및 프로덕션 설정** ✅ - 완료
  - ✅ Vercel 프로젝트 연결 (GitHub 연동 자동 배포) 및 환경 변수 3종 등록
  - ✅ Supabase 현재 프로젝트 프로덕션으로 재사용
  - ✅ 프로덕션 빌드 검증 (pnpm build 성공, Proxy Middleware 인식 확인)
  - ✅ OG 이미지 및 openGraph/Twitter Card 메타데이터 설정
  - ✅ 배포 후 프로덕션 스모크 테스트 통과 — https://budit.vercel.app
